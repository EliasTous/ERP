...
{
    public partial class ImportRTW : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!X.IsAjaxRequest && !IsPostBack)
            {
                ...
                try
                {
                    AccessControlApplier.ApplyAccessControlOnPage(typeof(AionHR.Model.Employees.Profile.ImportRTW), null, null, null, null);
                }
        ...
        protected void ProcessData(object sender, DirectEventArgs e)
        {
            try
            {
                ...
                EmployeeRTWImportingService service = null;
                service = new EmployeeRTWImportingService(new CSVImporter(CurrentPath.Text));
                List<EmployeeRightToWork> shifts = service.ImportUnvalidated(CurrentPath.Text);
                ...
                EmployeeRTWBatchRunner runner = new EmployeeRTWBatchRunner(_system, emp) { Items = shifts, OutputPath = MapPath("~/Imports/" + _systemService.SessionHelper.Get("AccountId") + "/") };
                runner.Process();
        ...
        protected void DownloadResult(object sender, DirectEventArgs e)
        {
            ...
            try
            {
                content = File.ReadAllText(MapPath("~/Imports/" + _systemService.SessionHelper.Get("AccountId") + "/" + ClassId.EPRW.ToString() + ".csv"));
            }
