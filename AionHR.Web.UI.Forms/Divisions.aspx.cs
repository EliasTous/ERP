    ...
    public partial class Divisions : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!X.IsAjaxRequest && !IsPostBack)
            {
                ...
                try
                {
                    AccessControlApplier.ApplyAccessControlOnPage(typeof(Division), BasicInfoTab, GridPanel1, btnAdd, SaveButton);
                }
        ...
        private DivisonsReport GetReport()
        {

            ListRequest req = new ListRequest();
            ListResponse<Model.Company.Structure.Division> resp = _branchService.ChildGetAll < Model.Company.Structure.Division > (req);
            if (!resp.Success)
            {
                X.MessageBox.ButtonText.Ok = Resources.Common.Ok;
            ...
            DivisonsReport p = new DivisonsReport();
