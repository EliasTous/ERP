...
<body style="background: url(Images/bg.png) repeat;" ">
    <form id="Form1" runat="server">
        ...
        <ext:Store
            ...
            <Sorters>
                <ext:DataSorter Property="payCode" Direction="ASC" />
            </Sorters>
        </ext:Store>
                ...
                <ext:GridPanel 
                    ...
                    <ColumnModel ID="ColumnModel1" runat="server" SortAscText="<%$ Resources:Common , SortAscText %>" SortDescText="<%$ Resources:Common ,SortDescText  %>" SortClearText="<%$ Resources:Common ,SortClearText  %>" ColumnsText="<%$ Resources:Common ,ColumnsText  %>" EnableColumnHide="false" Sortable="false" >
                        <Columns>
                            ...
                            <ext:Column CellCls="cellLink" ID="ColCode" MenuDisabled="true" runat="server" Text="<%$ Resources: paycode%>" DataIndex="payCode" Flex="2" Hideable="false"/>
                    ...
                    <DirectEvents>
                        <CellClick OnEvent="PoPuP">
                            <EventMask ShowMask="true" />
                            <ExtraParams>
                                <ext:Parameter Name="payCode" Value="record.data['payCode']" Mode="Raw" />
