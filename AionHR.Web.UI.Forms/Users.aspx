<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Users.aspx.cs" Inherits="Web.UI.Forms.Users" %>
                        ...
                        <ext:FormPanel DefaultButton="SaveButton"
                           ...
                           <%--     <ext:Checkbox ID="isAdminCheck" TabIndex="5" runat="server" FieldLabel="<%$ Resources: FieldIsAdmin%>" DataIndex="isAdmin" Name="isAdmin" InputValue="true" />--%>
                                   ...
                                   <%--     <ext:ListItem Text="<%$Resources:FieldSuperUser %>" Value="1" />
                                       ...
                                       <Listeners>
                                           <Select Handler="if (this.value!=1 && this.value!=2) #{employeeId}.allowBlank = false; else #{employeeId}.allowBlank = true; #{employeeId}.validate(); "></Select>
                                       </Listeners>
                                </ext:ComboBox>
