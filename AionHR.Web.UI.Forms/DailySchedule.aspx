...
<head runat="server">
    ...
    <link rel="stylesheet" href="CSS/DailySchedule.css?id=10" />
    <link rel="stylesheet" href="CSS/defaultTheme.css?id=10" />
    ...
    <script type="text/javascript" src="Scripts/plugins/jquery.fixedheadertable.min.js?id=1"></script>
