<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RT113.aspx.cs" Inherits="Web.UI.Forms.Reports.RT113" %>
          ...
          <ext:Window runat="server"  Icon="PageEdit"
            ...
            <Items>
                <ext:Panel runat="server" Layout="FitLayout"  ID="Panel8" DefaultAnchor="100%">
                    <Loader runat="server" Url="../ReportParameterBrowser.aspx?_reportName=RT113" Mode="Frame" ID="Loader8" TriggerEvent="show"
                        ReloadOnEvent="true"
                        DisableCaching="true">
                        <Listeners>
                         </Listeners>
