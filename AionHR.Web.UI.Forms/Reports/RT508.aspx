<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RT508.aspx.cs" Inherits="AionHR.Web.UI.Forms.RT508" %>
                                ...
                                <ext:Container runat="server" Layout="FitLayout">
                                 ...
                                 <ext:Container runat="server" Layout="FitLayout">
                                    <Content>
                                        ...
                                        <uc:jobInfo runat="server" ID="jobInfo1" EnableDepartment="true" EnablePosition="true" EnableDivision="false" EnableBranch="true" />
                                    </Content>
                                </ext:Container>
                                 <ext:Container runat="server" Layout="FitLayout">
                                    <Content>
