<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RT201.aspx.cs" Inherits="Web.UI.Forms.Reports.RT201" %>
...
<body style="background: url(Images/bg.png) repeat;">
    <form id="Form1" runat="server">
        ...
        <ext:Hidden ID="loaderUrl" runat="server"  Text="../ReportParameterBrowser.aspx?_reportName=RT201&values="/>
        ...
        <ext:Viewport ID="Viewport1" runat="server" Layout="FitLayout">
            ...
            <Items>
                ...
                <ext:Panel
                    ...
                    <Items>
                        <ext:Label runat="server" Text="ss" Hidden="true" />
                    </Items>
                </ext:Panel>
         ...
         <ext:Window runat="server"  Icon="PageEdit"
            ...
            <Items>
                <ext:Panel runat="server" Layout="FitLayout"  ID="Panel8" DefaultAnchor="100%">
                    <Loader runat="server" Url="../ReportParameterBrowser.aspx?_reportName=RT201" Mode="Frame" ID="Loader8" TriggerEvent="show"
                        ReloadOnEvent="true"
                        DisableCaching="true">
                        <Listeners>
                         </Listeners>
