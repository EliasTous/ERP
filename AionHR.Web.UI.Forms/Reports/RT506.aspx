<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RT506.aspx.cs" Inherits="AionHR.Web.UI.Forms.Reports.RT506" %>
...
<ext:Hidden ID="loaderUrl" runat="server"  Text="../ReportParameterBrowser.aspx?_reportName=RT506&values="/>
           ...
           <ext:Window runat="server"  Icon="PageEdit"
            ...
            <Items>
                <ext:Panel runat="server" Layout="FitLayout"  ID="Panel8" DefaultAnchor="100%">
                    <Loader runat="server" Url="../ReportParameterBrowser.aspx?_reportName=RT506" Mode="Frame" ID="Loader8" TriggerEvent="show"
                        ReloadOnEvent="true"
                        DisableCaching="true">
                        <Listeners>
                         </Listeners>
