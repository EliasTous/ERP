                                 ...
                                 <ext:Container runat="server" Layout="FitLayout">
                                  ...
                                  <ext:ComboBox  AnyMatch="true" CaseSensitive="false"  runat="server" ID="dayStatus"  Editable="false" EmptyText="<%$ Resources: FieldDayStatus %>" ForceSelection="true" Width="150">
                                            <Items>
                                                ...
                                                <ext:ListItem Text="<%$ Resources:  workingDay %>" Value="1" />
                                                <ext:ListItem Text="<%$ Resources:  Paidleave %>" Value="2" />
                                                  <ext:ListItem Text="<%$ Resources:  OpenDay %>" Value="3" />
                                                  <ext:ListItem Text="<%$ Resources:  UnPaidleave %>" Value="4" />
                                                  <ext:ListItem Text="<%$ Resources:  LeaveWithoutExcuse %>" Value="5" />
