<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RT308A.aspx.cs" Inherits="AionHR.Web.UI.Forms.Reports.RT308A" %>
           ...
           <ext:Window runat="server"  Icon="PageEdit"
            ...
            <Items>
                <ext:Panel runat="server" Layout="FitLayout"  ID="Panel8" DefaultAnchor="100%">
                    <Loader runat="server" Url="../ReportParameterBrowser.aspx?_reportName=RT308" Mode="Frame" ID="Loader8" TriggerEvent="show"
                        ReloadOnEvent="true"
                        DisableCaching="true">
                        <Listeners>
                         </Listeners>
