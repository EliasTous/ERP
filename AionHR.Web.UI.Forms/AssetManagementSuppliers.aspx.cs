...
{
    public partial class AssetManagementSuppliers : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!X.IsAjaxRequest && !IsPostBack)
            {
                ...
                try
                {
                    AccessControlApplier.ApplyAccessControlOnPage(typeof(AssetManagementSupplier), BasicInfoTab, GridPanel1, btnAdd, SaveButton);
                }
        ...
        protected void PoPuP(object sender, DirectEventArgs e)
        {
            ...
            switch (type)
            {
                case "imgEdit":
                    ...
                    RecordResponse<AssetManagementSupplier> response = _assetManagementService.ChildGetRecord<AssetManagementSupplier>(r);
                    if (!response.Success)
                    {
                        X.MessageBox.ButtonText.Ok = Resources.Common.Ok;
        ...
        public void DeleteRecord(string index)
        {
            try
            {
                ...
                AssetManagementSupplier n = new AssetManagementSupplier();
                n.recordId = index;
                n.name = "";
              


                PostRequest<AssetManagementSupplier> req = new PostRequest<AssetManagementSupplier>();
                req.entity = n;
                PostResponse<AssetManagementSupplier> res = _assetManagementService.ChildDelete<AssetManagementSupplier>(req);
                if (!res.Success)
                {
        ...
        protected void Store1_RefreshData(object sender, StoreReadDataEventArgs e)
        {
            ...
            request.Filter = "";
            ListResponse<AssetManagementSupplier> resp = _assetManagementService.ChildGetAll<AssetManagementSupplier>(request);
            if (!resp.Success)
            {
