...
{
    public partial class ImportLoans : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!X.IsAjaxRequest && !IsPostBack)
            {
                ...
                try
                {
                    AccessControlApplier.ApplyAccessControlOnPage(typeof(Model.LoadTracking.ImportLoans), null, null, null, null);
                }
        ...
        protected void ProcessData(object sender, DirectEventArgs e)
        {
            try
            {
                ...
                LoansBatchRunner runner = new LoansBatchRunner(storage,  _system, _timeAtt, emp) { Items = shifts, OutputPath = MapPath("~/Imports/"+_systemService.SessionHelper.Get("AccountId")+"/") };
                runner.Process();
        ...
        protected void DownloadResult(object sender, DirectEventArgs e)
        {
            ...
            try
            {
                content = File.ReadAllText(MapPath("~/Imports/" + _systemService.SessionHelper.Get("AccountId") + "/" + ClassId.LTLR.ToString() + ".csv"));
            }
