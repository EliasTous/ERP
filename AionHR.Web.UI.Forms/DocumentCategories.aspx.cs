...
{
    public partial class DocumentCategories : System.Web.UI.Page
    {
        ...
        protected void PoPuP(object sender, DirectEventArgs e)
        {
            ...
            switch (type)
            {
                case "imgEdit":
                    ...
                    RecordResponse<DocumentCategory> response = _administrationService.ChildGetRecord<DocumentCategory>(r);
                    if (!response.Success)
                    {
                        X.MessageBox.ButtonText.Ok = Resources.Common.Ok;
        ...
        public void DeleteRecord(string index)
        {
            try
            {
                ...
                DocumentCategory s = new DocumentCategory();
                s.recordId = index;
                s.name = "";
                //s.intName = "";

                PostRequest<DocumentCategory> req = new PostRequest<DocumentCategory>();
                req.entity = s;
                PostResponse<DocumentCategory> r = _administrationService.ChildDelete<DocumentCategory>(req);
                if (!r.Success)
                {
                    X.MessageBox.ButtonText.Ok = Resources.Common.Ok;
        ...
        protected void Store1_RefreshData(object sender, StoreReadDataEventArgs e)
        {
            ...
            request.Filter = "";
            ListResponse<DocumentCategory> routers = _administrationService.ChildGetAll<DocumentCategory>(request);
            if (!routers.Success)
            {
        ...
        protected void SaveNewRecord(object sender, DirectEventArgs e)
        {
            ...
            DocumentCategory b = JsonConvert.DeserializeObject<DocumentCategory>(obj);
            ...
            if (string.IsNullOrEmpty(id))
            {
                ...
                try
                {
                    ...
                    PostRequest<DocumentCategory> request = new PostRequest<DocumentCategory>();

                    request.entity = b;
                    PostResponse<DocumentCategory> r = _administrationService.ChildAddOrUpdate<DocumentCategory>(request);
            ...
            else
            {
                ...
                try
                {
                    ...
                    PostRequest<DocumentCategory> request = new PostRequest<DocumentCategory>();
                    request.entity = b;
                    PostResponse<DocumentCategory> r = _administrationService.ChildAddOrUpdate<DocumentCategory>(request);                      //Step 1 Selecting the object or building up the object for update purpose
