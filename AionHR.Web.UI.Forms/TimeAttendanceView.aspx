...
<body style="background: url(Images/bg.png) repeat;" onload="startRefresh();">
    <form id="Form1" runat="server">
                    ...
                    <ColumnModel ID="ColumnModel1" runat="server" SortAscText="<%$ Resources:Common , SortAscText %>" SortDescText="<%$ Resources:Common ,SortDescText  %>" SortClearText="<%$ Resources:Common ,SortClearText  %>" ColumnsText="<%$ Resources:Common ,ColumnsText  %>" EnableColumnHide="false" Sortable="true">
                        <Columns>
                            ...
                            <ext:Column ID="ColCheckIn" MenuDisabled="true" runat="server" Text="<%$ Resources: FieldCheckIn%>" DataIndex="checkIn" Flex="2" Hideable="false">
                                <Renderer Handler="var checkIn=record.data['checkIn']==null?'':record.data['checkIn']; var olA = ''; if(record.data['OL_A']==null) return checkIn;if(record.data['OL_A']=='00:00') olA=''; else olA= record.data['OL_A']; var cssClass='';if(record.data['OL_A'][0]=='-') cssClass='color:red;'; var result = ' <div style= ' + cssClass +' > ' + checkIn + '<br/>' + olA + '</div>'; return result;" />
                                <SummaryRenderer Handler="return '<hr/>';" />
                            </ext:Column>
                            ...
                            <ext:Column ID="ColCheckOut" Sortable="true" MenuDisabled="true" runat="server" Text="<%$ Resources: FieldCheckOut%>" DataIndex="checkOut" Flex="2" Hideable="false">
                                <Renderer Handler="var checkOut=record.data['checkOut']==null?'':record.data['checkOut'];var olD = '';if(record.data['OL_D']==null) return checkOut ; if(record.data['OL_D']=='00:00') olD=''; else olD= record.data['OL_D']; var cssClass='';if(record.data['OL_D'][0]=='-') cssClass='color:red;'; var result = ' <div style= ' + cssClass +' > ' + checkOut + '<br/>' + olD + '</div>'; return result;" />
                                <SummaryRenderer Handler="return '<hr/>';" />
                            </ext:Column>
        ...
        <ext:Window
            ...
            AutoShow="false"
            Modal="true"
            Maximizable="false" Resizable="true" Draggable="false"
            Hidden="true"
            Layout="FitLayout">
        ...
        <ext:TabPanel ID="panelRecordDetails" runat="server" ActiveTabIndex="0" Border="false" DeferredRender="false">
            <Items>
                ...
                <ext:GridPanel runat="server"
                    ...
                    <Store>
                        <ext:Store runat="server" ID="flatScheduleStore">
                    ...
                    <ColumnModel runat="server">
                        <Columns>
                            ...
                            <ext:Column runat="server" DataIndex="employeeName" Text="<%$ Resources: FieldEmployeeName %>" Flex="1" />
                            <ext:Column runat="server" DataIndex="shiftId" Text="<%$ Resources: shiftId %>" Flex="1" />
                            <ext:Column runat="server" DataIndex="from" Text="<%$ Resources: from %>" Flex="1" />
                            <ext:Column runat="server" DataIndex="to" Text="<%$ Resources: to %>" Flex="1" />
                             <ext:Column runat="server" DataIndex="duration" Text="<%$ Resources: FieldDuration %>" Flex="1" />
                ...
                <ext:GridPanel
                    ...
                    <ColumnModel ID="ColumnModel2" runat="server" SortAscText="<%$ Resources:Common , SortAscText %>" SortDescText="<%$ Resources:Common ,SortDescText  %>" SortClearText="<%$ Resources:Common ,SortClearText  %>" ColumnsText="<%$ Resources:Common ,ColumnsText  %>" EnableColumnHide="false" Sortable="true">
                        <Columns>
                            ...
                            <ext:Column ID="Column2" MenuDisabled="true" runat="server" Text="<%$ Resources: FieldEmployeeName%>" DataIndex="employeeName" Flex="3" Hideable="false">
                              ...
                              <ext:Column ID="Column7" MenuDisabled="true" runat="server" Text="<%$ Resources: FieldClockDuration%>" DataIndex="clockDurationString" Flex="2" Hideable="false" />
                            
                         <ext:Column ID="CoDuration" Visible="true" DataIndex="durationString" runat="server" Text="<%$ Resources: FieldDuration %>" Flex="1" >
                                  
                                    
                             </ext:Column>
                                <ext:Column ID="Column8" MenuDisabled="true" runat="server" Text="<%$ Resources: FieldApprovalStatus%>" DataIndex="apStatusString" Flex="2" Hideable="false">
                            
                            </ext:Column>
                               <ext:Column ID="Column9" MenuDisabled="true" runat="server" Text="<%$ Resources: FieldDamageLevel%>" DataIndex="damageLevelString" Flex="2" Hideable="false">
