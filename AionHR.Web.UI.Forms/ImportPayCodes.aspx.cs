...
{
    public partial class ImportPayCodes : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!X.IsAjaxRequest && !IsPostBack)
            {
                ...
                try
                {
                    AccessControlApplier.ApplyAccessControlOnPage(typeof(AionHR.Model.Payroll.ImportPayCode), null, null, null, null);
                }
        ...
        protected void ProcessData(object sender, DirectEventArgs e)
        {
            try
            {
                ...
                PayCodeBatchRunner runner = new PayCodeBatchRunner(storage, _system, _timeAtt, PS) { Items = shifts, OutputPath = MapPath("~/Imports/" + _systemService.SessionHelper.Get("AccountId") + "/") };
                runner.Process();
        ...
        protected void DownloadResult(object sender, DirectEventArgs e)
        {
            ...
            try
            {
                content = File.ReadAllText(MapPath("~/Imports/" + _systemService.SessionHelper.Get("AccountId") + "/" + ClassId.PYPC.ToString() + ".csv"));
            }
