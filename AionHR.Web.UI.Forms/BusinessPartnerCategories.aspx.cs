...
{
    public partial class BusinessPartnerCategories : System.Web.UI.Page
    {
        ...
        protected void PoPuP(object sender, DirectEventArgs e)
        {
            ...
            switch (type)
            {
                case "imgEdit":
                    ...
                    RecordResponse<BusinessPartnerCategory> response = _administrationService.ChildGetRecord<BusinessPartnerCategory>(r);
                    if (!response.Success)
                    {
                        X.MessageBox.ButtonText.Ok = Resources.Common.Ok;
        ...
        public void DeleteRecord(string index)
        {
            try
            {
                ...
                BusinessPartnerCategory s = new BusinessPartnerCategory();
                s.recordId = index;
                s.name = "";
                //s.intName = "";

                PostRequest<BusinessPartnerCategory> req = new PostRequest<BusinessPartnerCategory>();
                req.entity = s;
                PostResponse<BusinessPartnerCategory> r = _administrationService.ChildDelete<BusinessPartnerCategory>(req);
                if (!r.Success)
                {
                    X.MessageBox.ButtonText.Ok = Resources.Common.Ok;
        ...
        protected void Store1_RefreshData(object sender, StoreReadDataEventArgs e)
        {
            ...
            request.Filter = "";
            ListResponse<BusinessPartnerCategory> routers = _administrationService.ChildGetAll<BusinessPartnerCategory>(request);
            if (!routers.Success)
            {
        ...
        protected void SaveNewRecord(object sender, DirectEventArgs e)
        {
            ...
            BusinessPartnerCategory b = JsonConvert.DeserializeObject<BusinessPartnerCategory>(obj);
            ...
            if (string.IsNullOrEmpty(id))
            {
                ...
                try
                {
                    ...
                    PostRequest<BusinessPartnerCategory> request = new PostRequest<BusinessPartnerCategory>();

                    request.entity = b;
                    PostResponse<BusinessPartnerCategory> r = _administrationService.ChildAddOrUpdate<BusinessPartnerCategory>(request);
            ...
            else
            {
                ...
                try
                {
                    ...
                    PostRequest<BusinessPartnerCategory> request = new PostRequest<BusinessPartnerCategory>();
                    request.entity = b;
                    PostResponse<BusinessPartnerCategory> r = _administrationService.ChildAddOrUpdate<BusinessPartnerCategory>(request);                      //Step 1 Selecting the object or building up the object for update purpose
