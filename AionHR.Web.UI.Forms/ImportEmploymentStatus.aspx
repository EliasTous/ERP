<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ImportEmploymentStatus.aspx.cs" Inherits="AionHR.Web.UI.Forms.ImportEmploymentStatus" %>
                    ...
                    <Items>
                        ...
                        <ext:Panel runat="server" Flex="2">
                            <Items>
                                ...
                                <ext:Panel  runat="server" Flex="1" Height="20" />
                                <ext:Button runat="server" Icon="DiskDownload" Text="<%$Resources:Download %>" MarginSpec="0 0 0 80">
                                    <DirectEvents>
