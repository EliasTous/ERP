...
<body style="background: url(Images/bg.png) repeat;">
    <form id="Form1" runat="server">
        ...
        <ext:Viewport runat="server" Layout="CardLayout" ActiveIndex="0" ID="Viewport1">
            <Items>
                <ext:GridPanel
                    ID="GridPanel1"
                    runat="server"
                    ...
                    <Items>
                        <ext:Panel ID="leftPanel" runat="server" Region="West" Layout="AutoLayout" Width="150" PaddingSpec="0 0 0 0" Padding="0" TitleAlign="Center" 
                            ...
                            <Items>
                                ...
                                <%--<ext:TreePanel Closable="false" runat="server" Title="<%$ Resources:Common , ActiveModule %>" RootVisible="false" ID="employeesTree" Scroll="Vertical">
                                    <SelectionModel>
                                    ...
                                    <Listeners>
                                        <ItemClick Handler="CheckSession(); onEmployeeTreeItemClick(record, e);" />
                                    </Listeners>
