<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserProperties.aspx.cs" Inherits="AionHR.Web.UI.Forms.UserProperties" %>
                ...
                <ext:GridPanel 
                    ...
                    <ColumnModel ID="ColumnModel1" runat="server" SortAscText="<%$ Resources:Common , SortAscText %>" SortDescText="<%$ Resources:Common ,SortDescText  %>" SortClearText="<%$ Resources:Common ,SortClearText  %>" ColumnsText="<%$ Resources:Common ,ColumnsText  %>" EnableColumnHide="false" Sortable="false" >
                        <Columns>
                            ...
                            <ext:Column    CellCls="cellLink" ID="ColMask" MenuDisabled="true" runat="server" Text="<%$ Resources: FieldMask%>" DataIndex="maskString" Flex="2" Hideable="false" />
