<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RT309.aspx.cs" Inherits="AionHR.Web.UI.Forms.Reports.RT309" %>
...
<ext:Hidden ID="loaderUrl" runat="server"  Text="ReportParameterBrowser.aspx?_reportName=RT309&values="/>
                                    ...
                                    <Content>
                                       ...
                                       <Listeners>
                                         ...
                                         <ext:Button runat="server" Text="<%$Resources:Common, Go %>" >
                                            <Listeners>
                                             <Click Handler="if(App.vals.value ==null || App.vals.value=='') if(App.direct.ExistMandatoryFields('RT309')){
           ...
           <ext:Window runat="server"  Icon="PageEdit"
            ...
            <Items>
                <ext:Panel runat="server" Layout="FitLayout"  ID="Panel8" DefaultAnchor="100%">
                    <Loader runat="server" Url="ReportParameterBrowser.aspx?_reportName=RT309" Mode="Frame" ID="Loader8" TriggerEvent="show"
                        ReloadOnEvent="true"
                        DisableCaching="true">
                        <Listeners>
                         </Listeners>
