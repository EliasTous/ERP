...
{
    public partial class NoticePeriods : System.Web.UI.Page
    {
        ...
        protected void PoPuP(object sender, DirectEventArgs e)
        {
            ...
            switch (type)
            {
                case "imgEdit":
                    ...
                    RecordResponse<NoticePeriod> response = _employeeService.ChildGetRecord<NoticePeriod>(r);
                    if (!response.Success)
                    {
                        X.MessageBox.ButtonText.Ok = Resources.Common.Ok;
        ...
        public void DeleteRecord(string index)
        {
            try
            {
                ...
                NoticePeriod s = new NoticePeriod();
                s.recordId = index;
                s.name = "";
                //s.intName = "";

                PostRequest<NoticePeriod> req = new PostRequest<NoticePeriod>();
                req.entity = s;
                PostResponse<NoticePeriod> r = _employeeService.ChildDelete<NoticePeriod>(req);
                if (!r.Success)
                {
                    X.MessageBox.ButtonText.Ok = Resources.Common.Ok;
        ...
        protected void SaveNewRecord(object sender, DirectEventArgs e)
        {
            ...
            NoticePeriod b = JsonConvert.DeserializeObject<NoticePeriod>(obj);
            ...
            if (string.IsNullOrEmpty(id))
            {
                ...
                try
                {
                    ...
                    PostRequest<NoticePeriod> request = new PostRequest<NoticePeriod>();

                    request.entity = b;
                    PostResponse<NoticePeriod> r = _employeeService.ChildAddOrUpdate<NoticePeriod>(request);
            ...
            else
            {
                ...
                try
                {
                    ...
                    PostRequest<NoticePeriod> request = new PostRequest<NoticePeriod>();
                    request.entity = b;
                    PostResponse<NoticePeriod> r = _employeeService.ChildAddOrUpdate<NoticePeriod>(request);                      //Step 1 Selecting the object or building up the object for update purpose
