<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LetterTemplates.aspx.cs" Inherits="AionHR.Web.UI.Forms.LetterTemplates" %>
                    ...
                    <Items>
                        <ext:FormPanel
                            ...
                            <Items>
                                ...
                                <ext:ComboBox AnyMatch="true" CaseSensitive="false" runat="server" ID="usage" AllowBlank="false" TabIndex="7" Name="usage"
                                    SubmitValue="true"
                                    TypeAhead="false"
                                    FieldLabel="<%$ Resources: Fieldusage%>">
                                    <Items>
                                        <ext:ListItem Text="<%$Resources:employeeUsage %>" Value="1" />
                                        <ext:ListItem Text="<%$Resources:companyUsage %>" Value="2" />
