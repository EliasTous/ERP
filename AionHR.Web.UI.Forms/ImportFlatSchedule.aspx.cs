...
{
    public partial class ImportFlatSchedule : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!X.IsAjaxRequest && !IsPostBack)
            {
                ...
                try
                {
                    AccessControlApplier.ApplyAccessControlOnPage(typeof(AionHR.Model.TimeAttendance.ImportAttendance), null, null, null, null);
                }
        ...
        {
            FlatScheduleImportingService service = null;
            string path = "";
            try
            {
                ...
                service = new FlatScheduleImportingService(new CSVImporter(path), _employeeService);
                fileUpload.Reset();
            }
            catch (Exception exp)
        ...
        protected void ProcessData(object sender, DirectEventArgs e)
        {
            try
            {
                ...
                FlatScheduleImportingService service = null;
                service = new FlatScheduleImportingService(new CSVImporter(CurrentPath.Text), _employeeService);
                List<FlatSchedule> shifts = service.ImportUnvalidated(CurrentPath.Text);
                ...
                FlatScheduleBatchRunner runner = new FlatScheduleBatchRunner(storage, _timeAtt, _system, emp) { Items = shifts, OutputPath= MapPath("~/Imports/" + _systemService.SessionHelper.Get("AccountId") + "/") };
                runner.Process();
        ...
        protected void DownloadResult(object sender, DirectEventArgs e)
        {
            ...
            try
            {
                content = File.ReadAllText(MapPath("~/Imports/" + _systemService.SessionHelper.Get("AccountId") + "/" + ClassId.TAFS.ToString() + ".csv"));
            }
