    ...
    public partial class TaskTypes : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!X.IsAjaxRequest && !IsPostBack)
            {
                ...
                try
                {
                    AccessControlApplier.ApplyAccessControlOnPage(typeof(TaskType), BasicInfoTab, GridPanel1, btnAdd, SaveButton);
                }
        ...
        protected void PoPuP(object sender, DirectEventArgs e)
        {
            ...
            switch (type)
            {
                case "imgEdit":
                    ...
                    RecordResponse<TaskType> response = _taskService.ChildGetRecord<TaskType>(r);
                    if (!response.Success)
                    {
                        X.MessageBox.ButtonText.Ok = Resources.Common.Ok;
        ...
        public void DeleteRecord(string index)
        {
            try
            {
                ...
                TaskType s = new TaskType();
                s.recordId = index;
                s.name = "";

                PostRequest<TaskType> req = new PostRequest<TaskType>();
                req.entity = s;
                PostResponse<TaskType> r = _taskService.ChildDelete<TaskType>(req);
                if (!r.Success)
                {
                    X.MessageBox.ButtonText.Ok = Resources.Common.Ok;
        ...
        protected void Store1_RefreshData(object sender, StoreReadDataEventArgs e)
        {
            ...
            request.Filter = "";
            ListResponse<TaskType> routers = _taskService.ChildGetAll<TaskType>(request);
            if (!routers.Success)
                return;
        ...
        protected void SaveNewRecord(object sender, DirectEventArgs e)
        {
            ...
            TaskType b = JsonConvert.DeserializeObject<TaskType>(obj);
            ...
            if (string.IsNullOrEmpty(id))
            {
                ...
                try
                {
                    ...
                    PostRequest<TaskType> request = new PostRequest<TaskType>();

                    request.entity = b;
                    PostResponse<TaskType> r = _taskService.ChildAddOrUpdate<TaskType>(request);
            ...
            else
            {
                ...
                try
                {
                    ...
                    PostRequest<TaskType> request = new PostRequest<TaskType>();
                    request.entity = b;
                    PostResponse<TaskType> r = _taskService.ChildAddOrUpdate<TaskType>(request);                      //Step 1 Selecting the object or building up the object for update purpose
        ...
        private TaskTypesReport GetReport()
        {

            ListRequest request = new ListRequest();

            request.Filter = "";
            ListResponse<TaskType> resp = _taskService.ChildGetAll<TaskType>(request);
            if (!resp.Success)
            {
                X.MessageBox.ButtonText.Ok = Resources.Common.Ok;
            ...
            TaskTypesReport p = new TaskTypesReport();
