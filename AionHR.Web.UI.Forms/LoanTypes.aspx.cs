    ...
    public partial class LoanTypes : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!X.IsAjaxRequest && !IsPostBack)
            {
                ...
                try
                {
                    AccessControlApplier.ApplyAccessControlOnPage(typeof(LoanType), BasicInfoTab, GridPanel1, btnAdd, SaveButton);
                }
        ...
        private LoanTypesReport GetReport()
        {

            ListRequest request = new ListRequest();

            request.Filter = "";
            ListResponse<LoanType> resp = _loanService.ChildGetAll<LoanType>(request);
            if (!resp.Success)
            {
                X.MessageBox.ButtonText.Ok = Resources.Common.Ok;
            ...
            LoanTypesReport p = new LoanTypesReport();
