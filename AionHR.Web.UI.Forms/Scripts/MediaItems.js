...
function GetTypeName(index) {
    switch (index) {
        case "0": case 0:
            return document.getElementById("TypeAudio").value;
            break;
        case "1": case 1:
            return document.getElementById("TypeVideo").value;
            break;
        case "2": case 2:
            return document.getElementById("TypeTextFile").value;
            break;
        case "3": case 3:
            return document.getElementById("TypePicture").value;
            break;
