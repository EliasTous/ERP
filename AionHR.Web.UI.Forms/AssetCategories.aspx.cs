...
{
    public partial class AssetCategories : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!X.IsAjaxRequest && !IsPostBack)
            {
                ...
                try
                {
                    AccessControlApplier.ApplyAccessControlOnPage(typeof(AssetCategory), BasicInfoTab, GridPanel1, btnAdd, SaveButton);
                }
        ...
        protected void PoPuP(object sender, DirectEventArgs e)
        {
            ...
            switch (type)
            {
                case "imgEdit":
                    ...
                    RecordResponse<AssetCategory> response = _employeeService.ChildGetRecord<AssetCategory>(r);
                    if (!response.Success)
                    {
                        X.MessageBox.ButtonText.Ok = Resources.Common.Ok;
                        string message = GetGlobalResourceObject("Errors", response.ErrorCode) != null ? GetGlobalResourceObject("Errors", response.ErrorCode).   ToString() + "<br>Technical Error: " + response.ErrorCode + "<br> Summary: " + response.LogId : response.Summary;
        ...
        public void DeleteRecord(string index)
        {
            try
            {
                ...
                AssetCategory s = new AssetCategory();
                s.recordId = index;

                s.name = "";
                PostRequest<AssetCategory> req = new PostRequest<AssetCategory>();
                req.entity = s;
                PostResponse<AssetCategory> r = _employeeService.ChildDelete<AssetCategory>(req);
                if (!r.Success)
                {
                    X.MessageBox.ButtonText.Ok = Resources.Common.Ok;
        ...
        protected void Store1_RefreshData(object sender, StoreReadDataEventArgs e)
        {
            ...
            request.Filter = "";
            ListResponse<AssetCategory> routers = _employeeService.ChildGetAll<AssetCategory>(request);
            if (!routers.Success)
            {
        ...
        protected void SaveNewRecord(object sender, DirectEventArgs e)
        {
            ...
            AssetCategory b = JsonConvert.DeserializeObject<AssetCategory>(obj);
            ...
            if (string.IsNullOrEmpty(id))
            {
                ...
                try
                {
                    ...
                    PostRequest<AssetCategory> request = new PostRequest<AssetCategory>();

                    request.entity = b;
                    PostResponse<AssetCategory> r = _employeeService.ChildAddOrUpdate<AssetCategory>(request);
            ...
            else
            {
                ...
                try
                {
                    ...
                    PostRequest<AssetCategory> request = new PostRequest<AssetCategory>();
                    request.entity = b;
                    PostResponse<AssetCategory> r = _employeeService.ChildAddOrUpdate<AssetCategory>(request);                      //Step 1 Selecting the object or building up the object for update purpose
        ...
        {
            AssetCategoriesReport p = GetReport();
            string format = "Pdf";
        ...
        private AssetCategoriesReport GetReport()
        {

            ListRequest request = new ListRequest();

            request.Filter = "";
            ListResponse<AssetCategory> resp = _employeeService.ChildGetAll<AssetCategory>(request);
            if (!resp.Success)
            {
                X.MessageBox.ButtonText.Ok = Resources.Common.Ok;
            ...
            AssetCategoriesReport p = new AssetCategoriesReport();
