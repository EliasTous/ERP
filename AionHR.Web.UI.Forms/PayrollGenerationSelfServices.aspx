<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PayrollGenerationSelfServices.aspx.cs" Inherits="AionHR.Web.UI.Forms.PayrollGenerationSelfServices" %>
                ...
                <ext:Panel ID="detailsPanel" runat="server"  Layout="fit">
                        ...
                        <ext:Toolbar  ID="Toolbar1" runat="server" ClassicButtonStyle="false" Dock="Top">
                            ...
                            <Items>
                                ...
                                <ext:Container Visible="false" runat="server" Layout="FitLayout">
                                   ...
                                   <ext:Button runat="server" Text="<%$ Resources: Common,Go%>" MarginSpec="0 0 0 0" Width="100" Visible="false">
                                    <Listeners>
                                 ...
                                 <ext:ToolbarSeparator runat="server" />
                                       <ext:Button runat="server" Icon="Printer" Visible="false">
                                    <Menu>
                           ...
                           <%--       <ext:Button runat="server"  AutoPostBack="true" Text="<%$ Resources: Common,Export%>" MarginSpec="0 0 0 0" >
                                  ...
                                  <DirectEvents>
                                   ...
                                   <ext:Button runat="server" Visible="false" Icon="TableGo">
                                    <Menu>
                                        <ext:Menu runat="server">
                                            <Items>
                                  ...
                                  <ext:Button Visible="false" runat="server" Text="<%$ Resources: DeleteAll%>" MarginSpec="0 0 0 0" Width="100" Icon="DatabaseDelete">
                                    <DirectEvents> 
                                        <Click OnEvent="deleteAllEmployeePayrolls" />
                                    </DirectEvents>
                                </ext:Button>
                                   <ext:Button Visible="false" runat="server" Text="<%$ Resources: payList%>" MarginSpec="0 0 0 0" Width="100" Icon="Mail">
                                    <DirectEvents> 
                    ...
                    <Items>
                        ...
                        <ext:GridPanel runat="server" ID="employeePayrolls" SortableColumns="false"
                            ...
                            <ColumnModel>
                                <Columns>
                                      <ext:Column Visible="false" runat="server" DataIndex="name" Text="<%$ Resources: FieldRef %>" width="75">
                                        <Renderer Handler="return record.data['name'].reference;" />
                                    </ext:Column>
                                    <ext:Column Visible="false" runat="server" DataIndex="name" Text="<%$ Resources: FieldEmployee%>" Flex="2">
                         ...
                         <%--           <ext:Column runat="server" DataIndex="branchName" Text="<%$ Resources: FieldBranch%>" Flex="1" />--%>
                                    <ext:Column runat="server" Visible="false" DataIndex="departmentName" Text="<%$ Resources: FieldDepartment%>" Flex="1" />
                                    ...
                                    <ext:Column runat="server" DataIndex="basicAmount" Text="<%$ Resources: FieldBasicAmount%>"  Flex="1">
                                        <Renderer Handler="return record.data['currencyRef']+'&nbsp; '+ record.data['basicAmount'] ;" />
                                        </ext:Column>
                                    
                                    <ext:Column runat="server" DataIndex="eAmount" Text="<%$ Resources: Entitlements%>"  Flex="1">
                                        <Renderer Handler="if(record.data['eAmount']==0) return '-';return  record.data['currencyRef'] +' &nbsp;'+ record.data['eAmount'];" />
                                        </ext:Column>
                                    
                                    <ext:Column runat="server" DataIndex="dAmount" Text="<%$ Resources: Deductions%>"  Flex="1">
                                        <Renderer Handler="if(record.data['dAmount']==0) return '-'; return '- '+record.data['currencyRef']+'&nbsp; '+ record.data['dAmount'] ;" />
                                     </ext:Column>
                                    <ext:Column runat="server" DataIndex="netSalary" Text="<%$ Resources: FieldNetSalary%>" Flex="1" >
                                        <Renderer Handler="if(record.data['netSalary']==0) return '-'; return record.data['currencyRef'] +'&nbsp; '+ record.data['netSalary'] ;" />
                                        </ext:Column>
                                    <ext:Column runat="server" DataIndex="cssAmount" Text="<%$ Resources: FieldCompanySocialSecurity%>" Flex="1" >
                                      <Renderer Handler="if(record.data['cssAmount']==0) return '-';return record.data['currencyRef'] +'&nbsp;'  + record.data['cssAmount']; " />
                                        </ext:Column>
                                     <ext:Column runat="server" DataIndex="essAmount" Text="<%$ Resources: FieldEmployeeSocialSecurity%>" Flex="1" >
