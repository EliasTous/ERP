<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AssetManagementLoans.aspx.cs" Inherits="AionHR.Web.UI.Forms.AssetManagementLoans" %>
                                ...
                                <ext:ToolbarSeparator runat="server" />
                                 <ext:Container runat="server"  Layout="FitLayout">
                                            <Content>
                                                ...
                                                <uc:AssetControl runat="server" ID="AssetFilter"   />
                                            </Content>
                                        </ext:Container>
                                <ext:ToolbarSeparator runat="server" />
                                  <ext:Container runat="server"  Layout="FitLayout">
                    ...
                    <ColumnModel ID="ColumnModel1" runat="server" SortAscText="<%$ Resources:Common , SortAscText %>" SortDescText="<%$ Resources:Common ,SortDescText  %>" SortClearText="<%$ Resources:Common ,SortClearText  %>" ColumnsText="<%$ Resources:Common ,ColumnsText  %>" EnableColumnHide="false" Sortable="false" >
                        <Columns>
                           ...
                           <ext:Column    CellCls="cellLink" ID="ColEmployeeName" MenuDisabled="true" runat="server" Text="<%$ Resources: FieldEmployee%>" DataIndex="employeeName" Flex="2" Hideable="false" />
                               ...
                               <ext:Column CellCls="cellLink" ID="Column2" MenuDisabled="true" runat="server" Text="<%$ Resources:FieldPosition%>" DataIndex="positionName" Flex="1" Hideable="false" /> 
                               <ext:Column CellCls="cellLink" ID="Column3" MenuDisabled="true" runat="server" Text="<%$ Resources:FieldBranch%>" DataIndex="branchName" Flex="1" Hideable="false" /> 
                            ...
                            <ext:Column CellCls="cellLink" ID="Column5" MenuDisabled="true" runat="server" Text="<%$ Resources:FieldComments%>" DataIndex="comments" Flex="2" Hideable="false" /> 
