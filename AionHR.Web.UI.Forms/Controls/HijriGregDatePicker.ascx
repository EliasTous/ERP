<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="HijriGregDatePicker.ascx.cs" 
    Inherits="Hijri_Greg_DatePicker_Sample.HijriGregDatePicker"  %>
...
<script type="text/javascript">
    ...
    document.onclick = function (e) {
        ...
        <table style="width: 205px;">
            <tr>
                <td>
                    <asp:Label ID="lblHijri" runat="server" Text="Hijri" CssClass="fldLabel" ></asp:Label>
                    <asp:TextBox ID="txtHijri" runat="server" ReadOnly="true"   CssClass="clsText"></asp:TextBox>
                </td>
                <td>
                    <asp:Label ID="lblGregorian" runat="server" Text="Gregorian" CssClass="fldLabel" ></asp:Label>
                    <asp:TextBox ID="txtGreg" runat="server" ReadOnly="true"  CssClass="clsText" ></asp:TextBox>
                </td>
                <td style="vertical-align:bottom;">
                    <asp:Image  ID="imgCalendar" AlternateText="calendar" ImageUrl="Images/calendar.gif" runat="server" />
                </td>
            </tr>
        </table>
