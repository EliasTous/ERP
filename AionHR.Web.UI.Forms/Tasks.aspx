<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Tasks.aspx.cs" Inherits="AionHR.Web.UI.Forms.Tasks" %>
...
<head runat="server">
    ...
    <script type="text/javascript" src="Scripts/Tasks.js?id=0" ></script>
            ...
            <Model>
                <ext:Model ID="Model1" runat="server" IDProperty="recordId">
                    <Fields>
                        ...
                        <ext:ModelField Name="assignToId" />
                        <ext:ModelField Name="inRelationToId" />
                        <ext:ModelField Name="ttId" />
                        <ext:ModelField Name="dueDate" />
                        <ext:ModelField Name="description" />
                        <ext:ModelField Name="completed" />
                        <ext:ModelField Name="ttName" />
                        <ext:ModelField Name="name" />
                        <ext:ModelField Name="assignToName" IsComplex="true" />
                        <ext:ModelField Name="inRelationToName" IsComplex="true" />
                    </Fields>
                </ext:Model>
            </Model>
            <Sorters>
                    ...
                    <Items>
                        <ext:FormPanel
                            ...
                            <Items>
                                ...
                                <ext:ComboBox   AnyMatch="true" CaseSensitive="false"  runat="server" ID="assignToId"
                                    DisplayField="fullName"
                                    ValueField="recordId" Name="assignToId"
                                    TypeAhead="false" AllowBlank="false"
                                    FieldLabel="<%$ Resources: FieldAssignToName%>"
                                    HideTrigger="true" SubmitValue="true"
                                    MinChars="3"
                                    TriggerAction="Query" ForceSelection="false">
                                    <Store>
                                        <ext:Store runat="server" ID="AssignToNameStore" AutoLoad="false">
                                            <Model>
                                                <ext:Model runat="server">
                                                    <Fields>
                                                        <ext:ModelField Name="recordId" />
                                ...
                                <ext:ComboBox   AnyMatch="true" CaseSensitive="false"  runat="server" ID="inRelationToId"
                                    DisplayField="fullName" Name="inRelationToId"
                                    ValueField="recordId"
                                    ...
                                    TriggerAction="Query" ForceSelection="false">
                                    <Store>
                                        <ext:Store runat="server" ID="InRelationToNameStore" AutoLoad="false">
                                            <Model>
                                                <ext:Model runat="server">
                                                    <Fields>
                                                        <ext:ModelField Name="recordId" />
                                ...
                                <ext:ComboBox   AnyMatch="true" CaseSensitive="false"  runat="server" ID="ttId" QueryMode="Local" ForceSelection="true" TypeAhead="true" MinChars="1"
                                    DisplayField="name" Name="ttId"
                                    ValueField="recordId"  AllowBlank="false"
                                    FieldLabel="<%$ Resources: FieldTTName %>">
                                    <Store>
                                        <ext:Store runat="server" ID="ttStore">
                                            <Model>
                                                <ext:Model runat="server">
                                                    <Fields>
                                                        <ext:ModelField Name="recordId" />
                                ...
                                <ext:DateField ID="dueDate" runat="server" FieldLabel="<%$ Resources:FieldDueDate%>" Name="dueDate" AllowBlank="false" />                                
                                <ext:TextArea   ID="description" runat="server" FieldLabel="<%$ Resources:FieldDescription%>" Name="description" AllowBlank="false"/>
                                <ext:TextField Visible="false" InputType="Password"   ID="descriptionField" runat="server" FieldLabel="<%$ Resources:FieldDescription%>" Name="description" AllowBlank="false"/>

                                <ext:Checkbox runat="server" Name="completed" InputValue="true" ID="completed" DataIndex="completed" FieldLabel="<%$ Resources:FieldCompleted%>" />
