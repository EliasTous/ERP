...
{
    public partial class ImportLeaves : System.Web.UI.Page
    {
        ...
        protected void ProcessData(object sender, DirectEventArgs e)
        {
            try
            {
                ...
                LeaveImportingService service = null;
                service = new LeaveImportingService(new CSVImporter(CurrentPath.Text));
                List<LeaveRequest> shifts = service.ImportUnvalidated(CurrentPath.Text);
