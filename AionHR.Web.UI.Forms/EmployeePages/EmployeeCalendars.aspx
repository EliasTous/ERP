<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmployeeCalendars.aspx.cs" Inherits="AionHR.Web.UI.Forms.EmployeePages.EmployeeCalendars" %>
    ...
    <form id="Form1" runat="server">
        ...
        <Items>
                ...
                <ext:GridPanel AutoUpdateLayout="true"
                    ID="employeeCalenderGrid" Collapsible="true"
                    runat="server"
                    PaddingSpec="0 0 1 0"
                    Header="true"
                    ...
                    <Store>
                        <ext:Store
                            ...
                            <Model>
                                <ext:Model ID="Model1" runat="server" IDProperty="dayIdDt">
                                    <Fields>
                    ...
                    <ColumnModel ID="ColumnModel1" runat="server" SortAscText="<%$ Resources:Common , SortAscText %>" SortDescText="<%$ Resources:Common ,SortDescText  %>" SortClearText="<%$ Resources:Common ,SortClearText  %>" ColumnsText="<%$ Resources:Common ,ColumnsText  %>" EnableColumnHide="false" Sortable="false">
                        <Columns>
                            ...
                            <ext:Column   MenuDisabled="true" runat="server" Text="<%$ Resources: FieldScheduleName%>" DataIndex="scName" Flex="7" Hideable="false"/>
                ...
                <ext:TabPanel ID="TabPanel1" runat="server" ActiveTabIndex="0" Border="false" DeferredRender="false">
                    <Items>
                        <ext:FormPanel
                            ...
                            BodyPadding="5">
                            <Items>
                                     <ext:DateField  ID="ecDate"  runat="server" Name="dayIdDt" FieldLabel="<%$ Resources:FieldECDate%>" AllowBlank="false" LabelWidth="150" />
                                 <ext:ComboBox   AnyMatch="true" CaseSensitive="false"  QueryMode="Local"  LabelWidth="150" ForceSelection="true" TypeAhead="true" MinChars="1" FieldLabel="<%$ Resources: FieldScheduleName %>" Name="scId" DisplayField="name" ValueField="recordId" runat="server" ID="scId">
                                            <Store>
                                  ...
                                  <ext:ComboBox   AnyMatch="true" CaseSensitive="false"  QueryMode="Local"  LabelWidth="150" ForceSelection="true" TypeAhead="true" MinChars="1" FieldLabel="<%$ Resources: FieldCalendarName %>" Name="caId" DisplayField="name" ValueField="recordId" runat="server" ID="caId">
                                            <Store>
