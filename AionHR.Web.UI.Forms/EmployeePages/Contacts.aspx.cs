...
namespace AionHR.Web.UI.Forms.EmployeePages
{
    public partial class Contacts : System.Web.UI.Page
    {
        ...
        private EmployeeEmergencyContact GetById(string id)
        {
        ...
        protected void PoPuPEM(object sender, DirectEventArgs e)
        {
            ...
            switch (type)
            {
                case "imgEdit":
                    ...
                    EmployeeEmergencyContact entity = GetById(id.ToString());
        ...
        protected void PoPuPC(object sender, DirectEventArgs e)
        {
        ...
        protected void ADDNewEC(object sender, DirectEventArgs e)
        {
            ...
            this.EditEmergencyContactWindow.Title = Resources.Common.AddNewRecord;
            FillRelationshipType();
            FillNationality();     
        ...
        protected void ADDNewC(object sender, DirectEventArgs e)
        {
        ...
        protected void SaveEMDocument(object sender, DirectEventArgs e)
        {
            ...
            EmployeeEmergencyContact b = JsonConvert.DeserializeObject<EmployeeEmergencyContact>(obj);
        ...
        protected void SaveCDocument(object sender, DirectEventArgs e)
        {
