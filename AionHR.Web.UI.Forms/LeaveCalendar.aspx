                                ...
                                <ext:Toolbar runat="server" ID="calTools" ClassicButtonStyle="true">
                                    <Items>
                                        ...
                                        <ext:Button runat="server" Text="<">
                                            <Listeners>
                                                <Click Handler="CheckSession(); if(parseInt(#{CurrentMonth}.value)<1) {#{currentMonth}.value = 12; #{CurrentYear}.value = parseInt(#{CurrentYear}.value) - 1; } else{ #{CurrentMonth}.value = parseInt(#{CurrentMonth}.value) -1; } App.direct.UpdateCal(#{CurrentMonth}.value,#{CurrentYear}.value); DayPilotScheduler1.focus();    #{monthLbl}.setText(getMonthByNumber(#{CurrentMonth}.value)); #{yearLbl}.setText(#{CurrentYear}.value);" />
                                            </Listeners>
                                        </ext:Button>
                                        <ext:Button runat="server" Text=">">
                                            <Listeners>
                                                <Click Handler="CheckSession(); if(parseInt(#{CurrentMonth}.value)>11) {#{currentMonth}.value = 1; #{CurrentYear}.value = parseInt(#{CurrentYear}.value) + 1; } else{ #{CurrentMonth}.value = parseInt(#{CurrentMonth}.value) + 1; } App.direct.UpdateCal(#{CurrentMonth}.value,#{CurrentYear}.value); alert('hi');   #{monthLbl}.setText(getMonthByNumber(#{CurrentMonth}.value));#{yearLbl}.setText(#{CurrentYear}.value);" />
                                            </Listeners>
                                        </ext:Button>
