    ...
    public partial class Benefits : System.Web.UI.Page
    {
        ...
        protected void PoPuP(object sender, DirectEventArgs e)
        {
            ...
            switch (type)
            {
                case "imgEdit":
                    ...
                    RecordResponse<Benefit> response = _benefitsService.ChildGetRecord<Benefit>(r);
                    if (!response.Success)
                    {
                        X.MessageBox.ButtonText.Ok = Resources.Common.Ok;
        ...
        public void DeleteRecord(string index)
        {
            try
            {
                ...
                s.name = "";
                PostRequest<Benefit> req = new PostRequest<Benefit>();
                req.entity = s;
                PostResponse<Benefit> r = _benefitsService.ChildDelete<Benefit>(req);
                if (!r.Success)
                {
                    X.MessageBox.ButtonText.Ok = Resources.Common.Ok;
        ...
        protected void SaveNewRecord(object sender, DirectEventArgs e)
        {
            ...
            Benefit b = JsonConvert.DeserializeObject<Benefit>(obj);
            ...
            if (string.IsNullOrEmpty(id))
            {
                ...
                try
                {
                    ...
                    PostRequest<Benefit> request = new PostRequest<Benefit>();

                    request.entity = b;
                    PostResponse<Benefit> r = _benefitsService.ChildAddOrUpdate<Benefit>(request);
            ...
            else
            {
                ...
                try
                {
                    ...
                    PostRequest<Benefit> request = new PostRequest<Benefit>();
                    request.entity = b;
                    PostResponse<Benefit> r = _benefitsService.ChildAddOrUpdate<Benefit>(request);                      //Step 1 Selecting the object or building up the object for update purpose
