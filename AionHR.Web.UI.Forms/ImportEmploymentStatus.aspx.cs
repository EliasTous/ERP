...
{
    public partial class ImportEmploymentStatus : System.Web.UI.Page
    {
        ...
        protected void ProcessData(object sender, DirectEventArgs e)
        {
            try
            {
                ...
                EmploymentHistoryImportingService service = null;
                service = new EmploymentHistoryImportingService(new CSVImporter(CurrentPath.Text));
                List<EmploymentHistory> shifts = service.ImportUnvalidated(CurrentPath.Text);
                ...
                EmploymentHistoryBatchRunner runner = new EmploymentHistoryBatchRunner(storage, _system, emp) { Items = shifts, OutputPath = MapPath("~/Imports/" + _systemService.SessionHelper.Get("AccountId") + "/") };
                runner.Process();
        ...
        protected void DownloadResult(object sender, DirectEventArgs e)
        {
            ...
            try
            {
                content = File.ReadAllText(MapPath("~/Imports/" + _systemService.SessionHelper.Get("AccountId") + "/" + ClassId.EPST.ToString() + ".csv"));
            }
