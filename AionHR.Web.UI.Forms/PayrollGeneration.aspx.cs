    ...
    public partial class PayrollGeneration : System.Web.UI.Page
    {
        ...
        private EmployeesPaySlip GetReport(string payId)
        {
            ...
            try
            {
                ...
                {
                    parameters.Add(GetLocalResourceObject("FieldPayrollRef").ToString(), resp.Items.First().payRef+" ( "+ resp.Items.First().startDate.ToString(_systemService.SessionHelper.GetDateformat())+" - "+ resp.Items.First().endDate.ToString(_systemService.SessionHelper.GetDateformat())+" )");
