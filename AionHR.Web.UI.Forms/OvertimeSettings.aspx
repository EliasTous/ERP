<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OvertimeSettings.aspx.cs" Inherits="AionHR.Web.UI.Forms.OvertimeSettings" %>
                ...
                <ext:GridPanel
                    ...
                    <TopBar>
                        <ext:Toolbar ID="Toolbar1" runat="server" ClassicButtonStyle="false">
                            <Items>
                                ...
                                <ext:ComboBox AnyMatch="true" CaseSensitive="false" runat="server" ID="employeeCombo" Width="130" LabelAlign="Top"
                                    DisplayField="fullName"
                                    ValueField="recordId" AllowBlank="true"
                                    TypeAhead="false"
                                    HideTrigger="true" SubmitValue="true"
                                    MinChars="3" EmptyText="<%$ Resources: FieldName%>"
                                ...
                                <ext:DateField runat="server" ID="dayField" EmptyText="<%$ Resources: Day%>" Width="130" LabelAlign="Top">
                                    <Listeners>
                    ...
                    <ColumnModel ID="ColumnModel1" runat="server" SortAscText="<%$ Resources:Common , SortAscText %>" SortDescText="<%$ Resources:Common ,SortDescText  %>" SortClearText="<%$ Resources:Common ,SortClearText  %>" ColumnsText="<%$ Resources:Common ,ColumnsText  %>" EnableColumnHide="false" Sortable="false">
                        <Columns>
                            ...
                            <ext:Column CellCls="cellLink" ID="Column1" MenuDisabled="true" runat="server" Text="<%$ Resources: Day%>" DataIndex="dayId" Width="100" Hideable="false">
                                <Renderer Handler="var d = moment(record.data['dayId'],'YYYYMMDD'); return d.format(App.dateFormat.value);" />
