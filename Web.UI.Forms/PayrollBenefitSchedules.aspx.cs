...
{
    public partial class PayrollBenefitSchedules : System.Web.UI.Page
    {
        ...
        protected void PoPuP(object sender, DirectEventArgs e)
        {
            ...
            switch (type)
            {
                case "imgEdit":
                    ...
                    RecordResponse<PayrollBenefitSchedule> response = _payrollService.ChildGetRecord<PayrollBenefitSchedule>(r);
                    if (!response.Success)
                    {
                        X.MessageBox.ButtonText.Ok = Resources.Common.Ok;
        ...
        public void DeleteRecord(string index)
        {
            try
            {
                ...
                PayrollBenefitSchedule s = new PayrollBenefitSchedule();
                s.recordId = index;
                //s.reference = "";

                s.name = "";
                PostRequest<PayrollBenefitSchedule> req = new PostRequest<PayrollBenefitSchedule>();
                req.entity = s;
                PostResponse<PayrollBenefitSchedule> r = _payrollService.ChildDelete<PayrollBenefitSchedule>(req);
                if (!r.Success)
                {
                    X.MessageBox.ButtonText.Ok = Resources.Common.Ok;
        ...
        protected void Store1_RefreshData(object sender, StoreReadDataEventArgs e)
        {
            ...
            request.Filter = "";
            ListResponse<PayrollBenefitSchedule> resp = _payrollService.ChildGetAll<PayrollBenefitSchedule>(request);
            if (!resp.Success)
            {
