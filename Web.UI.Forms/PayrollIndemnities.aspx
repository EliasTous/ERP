<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PayrollIndemnities.aspx.cs" Inherits="Web.UI.Forms.PayrollIndemnities" %>
                            ...
                            <Items>
                                <ext:GridPanel
                                    ...
                                    <TopBar>
                                        <ext:Toolbar runat="server">
                                            <Items>
                                                <ext:Button runat="server" Text="<%$ Resources:addPenalty %>" Icon="UserAdd" ID="btnAddResignation">
                                                    <Listeners>
