...
var attachRender = function (e) {
    if (e != 2) {
        ...
        return '<img class="imgGenerate"  style="cursor:pointer;" src="Images/Tools/collapse.png" />&nbsp;&nbsp;<img class="imgAttach"  style="cursor:pointer;" src="Images/Tools/application_edit.png" />';
...
{
    return document.getElementById("PeriodStatus" + status).value;
}