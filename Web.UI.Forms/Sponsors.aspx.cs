    ...
    public partial class Sponsors : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!X.IsAjaxRequest && !IsPostBack)
            {
                ...
                try
                {
                    AccessControlApplier.ApplyAccessControlOnPage(typeof(Sponsor), BasicInfoTab, GridPanel1, btnAdd, SaveButton);
                }
        ...
        private SponsorsReport GetReport()
        {

            ListRequest request = new ListRequest();

            request.Filter = "";
            ListResponse<Sponsor> resp = _employeeService.ChildGetAll<Sponsor>(request);
            if (!resp.Success)
            {
                X.MessageBox.ButtonText.Ok = Resources.Common.Ok;
            ...
            SponsorsReport p = new SponsorsReport();
