...
{
    public partial class PayrollArguments : System.Web.UI.Page
    {
        ...
        protected void PoPuP(object sender, DirectEventArgs e)
        {
            ...
            switch (type)
            {
                case "imgEdit":
                    ...
                    RecordResponse<PayrollArgument> response = _payrollService.ChildGetRecord<PayrollArgument>(r);
                    if (!response.Success)
                    {
                        X.MessageBox.ButtonText.Ok = Resources.Common.Ok;
        ...
        public void DeleteRecord(string index)
        {
            try
            {
                ...
                PayrollArgument s = new PayrollArgument();
                s.recordId = index;
                //s.reference = "";

                s.name = "";
                PostRequest<PayrollArgument> req = new PostRequest<PayrollArgument>();
                req.entity = s;
                PostResponse<PayrollArgument> r = _payrollService.ChildDelete<PayrollArgument>(req);
                if (!r.Success)
                {
                    X.MessageBox.ButtonText.Ok = Resources.Common.Ok;
