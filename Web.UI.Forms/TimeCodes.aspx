<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TimeCodes.aspx.cs" Inherits="Web.UI.Forms.TimeCodes" %>
                        ...
                        <ext:FormPanel
                            ...
                            <Items>
                              ...
                              <ext:ComboBox   AnyMatch="true" CaseSensitive="false"  ID="edType" runat="server" FieldLabel="<%$ Resources:FieldType%>" Name="edType" IDMode="Static" SubmitValue="true" ForceSelection="true">
                                ...
                                <ext:ComboBox   AnyMatch="true" CaseSensitive="false"      runat="server"  ValueField="key" QueryMode="Local" ForceSelection="true" TypeAhead="true" MinChars="1" DisplayField="value" ID="timecode" Name="timecode" FieldLabel="<%$ Resources:FieldTimeVariationType%>" ReadOnly="true"  >
