<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DaysAvailability.aspx.cs" Inherits="Web.UI.Forms.DaysAvailability" %>
                    ...
                    <TopBar>
                        <ext:Toolbar ID="Toolbar1" runat="server" ClassicButtonStyle="false">
                            <Items>
                                ...
                                <ext:DateField runat="server" ID="dateFrom" Width="150" LabelWidth="30" FieldLabel="<%$ Resources:Common, FieldDate %>" Editable="false" >
                                    <%--  <Listeners>
