...
{
    public partial class RT504 : System.Web.UI.Page
    {
        ...
        private void FillReport(bool isInitial = false, bool throwException = true)
        {
            ...
            ListResponse<Model.Reports.RT504> resp = _reportsService.ChildGetAll<Model.Reports.RT504>(req);
            if (!resp.Success)
                Common.ReportErrorMessage(resp, GetGlobalResourceObject("Errors", "Error_1").ToString(), GetGlobalResourceObject("Errors", "ErrorLogId").ToString());


            Dictionary<string, string> parameters = Web.UI.Forms.Common.FetchReportParameters(texts.Text);
            bankTransfer h = new bankTransfer(parameters);
