...
public class EmployeeDetails : DevExpress.XtraReports.UI.XtraReport
{
    ...
    private DevExpress.XtraReports.Parameters.Parameter Sponsor;
    ...
    public EmployeeDetails(Dictionary<string,string> parameters)
    {
        InitializeComponent();
    ...
    private void InitializeComponent()
    {
            ...
            this.Sponsor = new DevExpress.XtraReports.Parameters.Parameter();
            ...
            new DevExpress.XtraReports.UI.XRBinding("Text", null, "resRef")});
            ...
            new DevExpress.XtraReports.UI.XRBinding("Text", null, "contractDuration")});
            ...
            new DevExpress.XtraReports.UI.XRBinding("Text", null, "termEndDateString")});
    ...
    private void xrLabel39_BeforePrint(object sender, PrintEventArgs e)
    {
        e.Cancel = RowCount > 0;
    }
}
